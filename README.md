<p align="center">
  <img src="mail/logo.png" width="625" alt="Home Mail">
</p>
...
| `default_folder` | `INBOX` | Папка, открываемая при входе: `INBOX`, `IMPORTANT`, `FLAGGED`, `ALL`, `SENT`, `DRAFTS`, `JUNK` или `TRASH`. Если её нет в ящике, открываются входящие. |
