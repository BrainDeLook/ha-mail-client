...
shell.fire('touchstart', {target: sidebar, touches: [{clientX: 200, clientY: 200}]});
shell.fire('touchmove', {target: sidebar, touches: [{clientX: 170, clientY: 202}], preventDefault() {}});
shell.fire('touchend', {target: sidebar, changedTouches: [{clientX: 170, clientY: 202}]});
assert.equal(shell.classList.contains('show-sidebar'), true, 'short left swipe restores folders');
shell.fire('touchstart', {target: sidebar, touches: [{clientX: 200, clientY: 200}]});
shell.fire('touchmove', {target: sidebar, touches: [{clientX: 200, clientY: 280}], preventDefault() { throw Error('vertical folder scroll prevented'); }});
shell.fire('touchend', {target: sidebar, changedTouches: [{clientX: 200, clientY: 280}]});
assert.equal(shell.classList.contains('show-sidebar'), true, 'vertical folder scroll keeps sidebar open');
shell.fire('touchstart', {target: element('sidebar-scrim'), touches: [{clientX: 350, clientY: 200}]});
shell.fire('touchmove', {target: element('sidebar-scrim'), touches: [{clientX: 240, clientY: 202}], preventDefault() {}});
assert.equal(sidebar.style.transform, 'translate3d(-110px,0,0)', 'sidebar follows closing finger');
shell.fire('touchend', {target: element('sidebar-scrim'), changedTouches: [{clientX: 240, clientY: 202}]});
assert.equal(shell.classList.contains('show-sidebar'), false, 'left swipe on scrim closes folders');
listPane.fire('touchstart', {touches: [{clientX: 100, clientY: 200}]});
listPane.fire('touchmove', {touches: [{clientX: 220, clientY: 203}], preventDefault() {}});
listPane.fire('touchend', {changedTouches: [{clientX: 220, clientY: 203}]});
shell.fire('touchstart', {target: sidebar, touches: [{clientX: 210, clientY: 300}]});
shell.fire('touchmove', {target: sidebar, touches: [{clientX: 90, clientY: 302}], preventDefault() {}});
shell.fire('touchend', {target: sidebar, changedTouches: [{clientX: 90, clientY: 302}]});
assert.equal(shell.classList.contains('show-sidebar'), false, 'left swipe on folder pane still closes folders');
listPane.fire('touchstart', {touches: [{clientX: 100, clientY: 200}]});
listPane.fire('touchmove', {touches: [{clientX: 220, clientY: 203}], preventDefault() {}});
listPane.fire('touchend', {changedTouches: [{clientX: 220, clientY: 203}]});
